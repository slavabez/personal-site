...
export const alt = "Ivinco blog post";
export const size = {
  width: 1200,
  height: 630,
};
...
export default async function OGImage({
  ...
  const summary =
    blogPostData.frontmatter.description.length > 300
      ? blogPostData.frontmatter.description.slice(0, 300) + "..."
      : blogPostData.frontmatter.description;
